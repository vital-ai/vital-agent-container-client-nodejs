...
/**
 * VitalSigns class: http://vital.ai/ontology/chat-ai#QueryChatKGRequest
 */
export class QueryChatKGRequest extends HaleyChatCommand {
  ...
  constructor() {
    super();
    this.vitaltype = 'http://vital.ai/ontology/chat-ai#QueryChatKGRequest';
  }

  /**
   * Get property definitions for QueryChatKGRequest
   */
