...
/**
 * VitalSigns class: http://vital.ai/ontology/chat-ai#QueryActivityAdminRequest
 */
export class QueryActivityAdminRequest extends HaleyChatAdminCommand {
  ...
  constructor() {
    super();
    this.vitaltype = 'http://vital.ai/ontology/chat-ai#QueryActivityAdminRequest';
  }

  /**
   * Get property definitions for QueryActivityAdminRequest
   */
