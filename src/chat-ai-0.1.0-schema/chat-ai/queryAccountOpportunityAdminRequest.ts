...
/**
 * VitalSigns class: http://vital.ai/ontology/chat-ai#QueryAccountOpportunityAdminRequest
 */
export class QueryAccountOpportunityAdminRequest extends HaleyChatAdminCommand {
  ...
  constructor() {
    super();
    this.vitaltype = 'http://vital.ai/ontology/chat-ai#QueryAccountOpportunityAdminRequest';
  }

  /**
   * Get property definitions for QueryAccountOpportunityAdminRequest
   */
