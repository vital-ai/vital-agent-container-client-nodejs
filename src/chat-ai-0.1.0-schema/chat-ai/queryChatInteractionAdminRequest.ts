...
/**
 * VitalSigns class: http://vital.ai/ontology/chat-ai#QueryChatInteractionAdminRequest
 */
export class QueryChatInteractionAdminRequest extends HaleyChatAdminCommand {
  ...
  constructor() {
    super();
    this.vitaltype = 'http://vital.ai/ontology/chat-ai#QueryChatInteractionAdminRequest';
  }

  /**
   * Get property definitions for QueryChatInteractionAdminRequest
   */
