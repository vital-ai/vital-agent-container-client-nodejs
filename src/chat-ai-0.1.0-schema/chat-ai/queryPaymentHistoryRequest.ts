...
/**
 * VitalSigns class: http://vital.ai/ontology/chat-ai#QueryPaymentHistoryRequest
 */
export class QueryPaymentHistoryRequest extends HaleyChatCommand {
  ...
  constructor() {
    super();
    this.vitaltype = 'http://vital.ai/ontology/chat-ai#QueryPaymentHistoryRequest';
  }

  /**
   * Get property definitions for QueryPaymentHistoryRequest
   */
