...
/**
 * VitalSigns class: http://vital.ai/ontology/chat-ai#QueryModelRequest
 */
export class QueryModelRequest extends HaleyChatCommand {
  ...
  constructor() {
    super();
    this.vitaltype = 'http://vital.ai/ontology/chat-ai#QueryModelRequest';
  }

  /**
   * Get property definitions for QueryModelRequest
   */
