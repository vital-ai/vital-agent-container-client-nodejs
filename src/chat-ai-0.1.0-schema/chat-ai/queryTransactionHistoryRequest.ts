...
/**
 * VitalSigns class: http://vital.ai/ontology/chat-ai#QueryTransactionHistoryRequest
 */
export class QueryTransactionHistoryRequest extends HaleyChatCommand {
  ...
  constructor() {
    super();
    this.vitaltype = 'http://vital.ai/ontology/chat-ai#QueryTransactionHistoryRequest';
  }

  /**
   * Get property definitions for QueryTransactionHistoryRequest
   */
