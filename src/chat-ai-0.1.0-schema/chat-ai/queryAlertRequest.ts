...
/**
 * VitalSigns class: http://vital.ai/ontology/chat-ai#QueryAlertRequest
 */
export class QueryAlertRequest extends HaleyChatCommand {
  ...
  constructor() {
    super();
    this.vitaltype = 'http://vital.ai/ontology/chat-ai#QueryAlertRequest';
  }

  /**
   * Get property definitions for QueryAlertRequest
   */
