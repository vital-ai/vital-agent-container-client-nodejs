...
/**
 * VitalSigns class: http://vital.ai/ontology/chat-ai#QueryOrgUnitManagerRequest
 */
export class QueryOrgUnitManagerRequest extends HaleyChatManagerCommand {
  ...
  constructor() {
    super();
    this.vitaltype = 'http://vital.ai/ontology/chat-ai#QueryOrgUnitManagerRequest';
  }

  /**
   * Get property definitions for QueryOrgUnitManagerRequest
   */
