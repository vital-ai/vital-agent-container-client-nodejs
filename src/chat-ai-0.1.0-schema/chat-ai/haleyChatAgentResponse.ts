import { HaleyInterAccountResponse } from '../haley/haleyInterAccountResponse';
import { VitalSignsPropertyDefinition } from '@vital-ai/vital-model-utils';

/**
 * VitalSigns class: http://vital.ai/ontology/chat-ai#HaleyChatAgentResponse
 */
export class HaleyChatAgentResponse extends HaleyInterAccountResponse {
  ...
  constructor() {
    super();
    this.vitaltype = 'http://vital.ai/ontology/chat-ai#HaleyChatAgentResponse';
  }

  /**
   * Get property definitions for HaleyChatAgentResponse
   */
