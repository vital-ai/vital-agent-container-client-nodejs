...
/**
 * VitalSigns class: http://vital.ai/ontology/chat-ai#QueryOrgUnitRequest
 */
export class QueryOrgUnitRequest extends HaleyChatCommand {
  ...
  constructor() {
    super();
    this.vitaltype = 'http://vital.ai/ontology/chat-ai#QueryOrgUnitRequest';
  }

  /**
   * Get property definitions for QueryOrgUnitRequest
   */
