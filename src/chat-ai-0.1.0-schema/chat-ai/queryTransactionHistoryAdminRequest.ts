...
/**
 * VitalSigns class: http://vital.ai/ontology/chat-ai#QueryTransactionHistoryAdminRequest
 */
export class QueryTransactionHistoryAdminRequest extends HaleyChatAdminCommand {
  ...
  constructor() {
    super();
    this.vitaltype = 'http://vital.ai/ontology/chat-ai#QueryTransactionHistoryAdminRequest';
  }

  /**
   * Get property definitions for QueryTransactionHistoryAdminRequest
   */
