...
/**
 * VitalSigns class: http://vital.ai/ontology/chat-ai#QueryAssetRequest
 */
export class QueryAssetRequest extends HaleyChatCommand {
  ...
  constructor() {
    super();
    this.vitaltype = 'http://vital.ai/ontology/chat-ai#QueryAssetRequest';
  }

  /**
   * Get property definitions for QueryAssetRequest
   */
