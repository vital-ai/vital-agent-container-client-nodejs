...
/**
 * VitalSigns class: http://vital.ai/ontology/chat-ai#QueryOrgUnitMemberRequest
 */
export class QueryOrgUnitMemberRequest extends HaleyChatCommand {
  ...
  constructor() {
    super();
    this.vitaltype = 'http://vital.ai/ontology/chat-ai#QueryOrgUnitMemberRequest';
  }

  /**
   * Get property definitions for QueryOrgUnitMemberRequest
   */
