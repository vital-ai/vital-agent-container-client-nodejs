...
export class HaleyMindRequest extends VITAL_Node {
  ...
  public haleyMindAgentInstanceURI?: string;
  public commandProcessorNotificationChannelURI?: string;
  ...
  constructor() {
    super();
    this.vitaltype = 'http://vital.ai/ontology/haley#HaleyMindRequest';
  }
