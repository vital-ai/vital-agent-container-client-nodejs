...
export class AIMPTask extends VITAL_Node {
  public chatTaskStagesJSON?: string;
  public chatTaskStartDateTime?: string | Date;
  public timezone?: string;
  public aIMPTaskTypeURI?: string;
  public chatTotalTokenCount?: number;
  public chatTaskEndDateTime?: string | Date;
  public messageURI?: string;
  public chatCompletionTokenCount?: number;
  public daylightSavingsTime?: boolean;
  public aIMPMessageContentURI?: string;
  public chatTaskDeltaTime?: number;
  public chatTaskUpdateDateTime?: string | Date;
  public aIMPTaskStatusURI?: string;
  public chatPromptTokenCount?: number;
  public aIMPTaskProgressURI?: string;


  constructor() {
    super();
    this.vitaltype = 'http://vital.ai/ontology/vital-aimp#AIMPTask';
  }
