...
export class HaleyInteractionFlowStepInstance extends VITAL_Node {
  public interactionFlowStepInstanceSecondaryIndex?: number;
  public haleyInteractionFlowStepStateURI?: string;
  public interactionFlowStepInstanceIndex?: number;
  public interactionFlowStepInstanceRowInstanceURI?: string;
  public interactionFlowStepInstanceTertiaryIndex?: number;
  public haleyInteractionFlowStepURI?: string;
  public interactionFlowStepInstanceGroupInstanceURI?: string;
  public interactionFlowStepInstanceRowRowInstanceURI?: string;


  constructor() {
    super();
    this.vitaltype = 'http://vital.ai/ontology/haley-ai-question#HaleyInteractionFlowStepInstance';
  }
